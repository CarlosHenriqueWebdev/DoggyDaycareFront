        ...
        {contentData.data ? (
            ...
            {contentData.data.attributes.PrivacyPolicy.TitleAndDescription.map(
              (mapItem, index) => (
                <div key={mapItem.id}>
                  ...
                  {index !==
                    contentData.data.attributes.PrivacyPolicy
                      .TitleAndDescription.length -
                      1 && (
                    <hr
                      aria-hidden="true"
                      className="my-[32px] border-black75"
                    />
                  )}
                </div>
              )
          ...
          >
            ...
            <p className="w-fit bg-skeletonLoading mt-[12px]">
              ...
              consequuntur libero corrupti. Nam, quibusdam ratione cum amet
              eaque ipsa. Distinctio, nulla iste!
            </p>
                ...
                <div key={itemIndex}>
                  <li>
                    ...
                    <ul className="grid gap-[8px] mt-[12px]">
                      {Array.from({ length: 4 }, (_, itemIndex) => (
                        <li
                          className="w-fit bg-skeletonLoading"
                          key={itemIndex}
                        >
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Non amet tempora velit commodi deserunt nobis
                          nisi. Vel, accusamus quae? Veniam quaerat assumenda
                          quidem aliquid impedit perferendis deleniti quasi odit
                          exercitationem.
                        </li>
                      ))}
                    </ul>
                  ...
                  {itemIndex !== 3 && (
                    <hr
                      aria-hidden="true"
                      className="my-[32px] border-black25"
                    />
                  )}
                </div>
              ))}
